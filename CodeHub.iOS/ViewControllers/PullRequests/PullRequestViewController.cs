...
namespace CodeHub.Views.PullRequests
{
    public class PullRequestViewController : PrettyDialogViewController<PullRequestViewModel>
    {
        ...
        public PullRequestViewController(string username, string repository, long id)
        {
            ViewModel = new PullRequestViewModel(username, repository, id);
        }
        ...
        public override void ViewDidLoad()
        {
            ...
            OnActivation(d =>
            {
                ...
                ViewModel.WhenAnyValue(x => x.IsModifying).SubscribeStatus("Loading...").AddTo(d);
        ...
        private void ShowExtraMenu()
        {
            ...
            sheet.Dismissed += (s, e) =>
            {
                BeginInvokeOnMainThread(() =>
                {
                    ...
                    {
                        var view = new WebBrowserViewController(ViewModel.PullRequest.HtmlUrl);
