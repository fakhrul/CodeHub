...
{
    public class EditSourceViewController : BaseViewController<EditSourceViewModel>
    {
        ...
        public EditSourceViewController(string username, string repository, string branch = null, string path = null)
            : this()
        {
            ViewModel = new EditSourceViewModel(username, repository, branch, path);
        }
        ...
        public override void ViewDidLoad()
        {
            ...
            OnActivation(d =>
            {
                saveButton.GetClickedObservable().Subscribe(_ => Commit()).AddTo(d);
                this.WhenAnyValue(x => x.ViewModel.Text).Subscribe(x => {
                    _textView.Text = x;
